#Intro to DS - Unit 4 - California Health Infomration Survey Exercise
#Submitted by Maya Bhat-Gregerson
#September 4, 2018


##BASIC HISTOGRAMS - BY AGE, BY BMI GROUP, AND BOTH COMBINED
##DATA CLEANING TO EXCLUDE EXTREME AGE AND BMI VALUES
...
adult$RBMI <- factor(adult$RBMI, labels = c("Under-wdight", "Normal-weight", "Over-weight", "Obese"))
...
###CREATING HISTOGRAMS OF AGE BY BMI GROUP - NO FACETS
...
### CREATING FACETTED HISTOGRAMS OF AGE DISTRIBUTION BY BMI GROUP
...
### MOSAIC PLOT OF CHI SQUARE RESIDUALS OF AGE AND BMI CATEGORY
...
###ADDING LABELS TO MOSAIC PLOT AXES AND RECTANGLES
...
## CREATING FUNCTIONS TO CREATE APPROPRIATELY FORMATTED/LABELLED MOSAIC PLOTS FOR ANY TWO VARIABLES 
